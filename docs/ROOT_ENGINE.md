...
No se elimina el archivo en este ciclo para mantener el cambio reversible. Antes de conectar cualquier capacidad root/sysfs se debe hacer una revisión independiente de seguridad, permisos, validación de rutas y pruebas en dispositivos compatibles.
